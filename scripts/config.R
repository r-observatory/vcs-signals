...
AI_TRAILER_PATTERNS <- list(
  ...
  # Anchored to the start of a line. Unanchored it matched prose: a real commit
  # reads "Clarify that duplicate workflows are auto-generated by Replit's
  # infrastructure", which is a maintainer describing Replit, not Replit signing.
  # The corpus caught this the first time the rule was checked against strings
  # from the world rather than from the ruleset.
  list(pattern = "(^|\\n)\\s*generated by replit\\b",                          tool = "replit",
